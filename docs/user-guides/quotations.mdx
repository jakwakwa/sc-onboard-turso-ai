...
Quotes are generated automatically by Gemini AI when an applicant reaches Stage 2 of the onboarding workflow. The quote is stored as a draft and requires staff approval before the client can sign it. Once the client signs, the workflow continues to contract signing.
