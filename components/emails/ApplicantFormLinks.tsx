...
export const ApplicantFormLinks = ({
	...
	return (
		<EmailLayout preview={previewText}>
			...
			<Text className="text-black text-[14px] leading-[24px]">
				We're excited to have you on board. To complete your application, please
				fill out the following forms and upload the necessary documents.
			</Text>
			...
			<Text className="text-[#666666] text-[12px] leading-[24px]">
				If you have any questions, please reply to this email or contact your
				account manager.
			</Text>
		</EmailLayout>
	);
