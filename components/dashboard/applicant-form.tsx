				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
					...
					<div className="space-y-2">
						...
						<select
							...
							className={cn(
								...
								errors.entityType ? "border-red-500" : "border-input-border"
							)}>
						...
						{errors.entityType && (
							<p className="text-xs text-red-400">{errors.entityType}</p>
						)}
					</div>
					...
					<div className="space-y-2">
						...
						<select
							...
							className={cn(
								"flex h-10 w-full rounded-md border bg-background px-3 py-2 text-sm ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50",
								errors.productType ? "border-red-500" : "border-input-border"
							)}>
						...
						{errors.productType && (
							<p className="text-xs text-red-400">{errors.productType}</p>
						)}
					</div>
