	...
	return (
		<TabsPrimitive.Trigger
			...
			className={cn(
				...
				"data-active:bg-linear-to-b data-active:from-amber-300 via-90% via-amber-300/55 data-active:to-secondary/80 dark:data-active:text-foreground dark:data-active:border-input dark:data-active:bg-input/30 data-active:text-white",
