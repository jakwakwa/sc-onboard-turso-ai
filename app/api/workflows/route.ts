...
const createWorkflowSchema = z.object({
    ...
    stageName: z.enum(['lead_capture', 'dynamic_quotation', 'verification', 'integration']).default('lead_capture'),
    status: z.enum(['pending', 'in_progress', 'awaiting_human', 'completed', 'failed', 'timeout']).default('pending'),
